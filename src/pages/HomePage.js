...
const HomePage = () => {
    ...
    const vista1 = () => {
        ...
        if (!open) {
            ...
            document.getElementById("item2").style.width = "500px";
    ...
    return (
        <Card className="container" style={style}>
            ...
            <CardContent className="item1" id='item1' sx={{ background: 'black', borderRadius: '1rem', display: 'block', color: 'white', height: '300px'}}>
            ...
            <CardContent className="item2" id='item2' sx={{ background: 'black', display: 'block', borderRadius: '1rem', color: 'white', height: '300px'}}>
            <ScrollbarWrapper>
                    Un texto es una composición de signos codificados en un sistema de escritura que forma una unidad de sentido.
            ...
            <CardContent className="item3" id='item3' sx={{ background: 'black', display: 'block', borderRadius: '1rem', color: 'white', height: '300px' }}>
                 <ScrollbarWrapper>
                    Un texto es una composición de signos codificados en un sistema de escritura que forma una unidad de sentido.
            ...
            <CardContent className="item4" id='item4' sx={{ background: 'black', display: 'block',borderRadius: '1rem', color: 'white', height: '300px' }}>
            <ScrollbarWrapper>
                    Un texto es una composición de signos codificados en un sistema de escritura que forma una unidad de sentido.
            ...
            <CardContent className="item5" id='item5' sx={{ background: 'black', display: 'block', borderRadius: '1rem', color: 'white', height: '300px' }}>
            <ScrollbarWrapper>
                    Un texto es una composición de signos codificados en un sistema de escritura que forma una unidad de sentido.
            ...
            <CardContent className="item6" id='item6' sx={{ background: 'black', display: 'block', borderRadius: '1rem', color: 'white', height: '300px' }}>
            <ScrollbarWrapper>
                    Un texto es una composición de signos codificados en un sistema de escritura que forma una unidad de sentido.
